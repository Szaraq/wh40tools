(function( $, undefined ) {
    ...
    inline: false
      ...
      addMobileStyle: function(){
          ...
          .find(".ui-datepicker-prev").addClass("ui-btn-icon-notext ui-btn-inline ui-corner-all ui-icon-arrow-l ui-shadow ui-btn-b").end()
          .find(".ui-datepicker-next").addClass("ui-btn-icon-notext ui-btn-inline ui-corner-all ui-icon-arrow-r ui-shadow ui-btn-b").end()
